...
for m in [32, 64, 128, 256, 512]:
    for q in [8]:
        ...
        callMe(cfg_path ='configs/config_arc/arc_res50.yaml', cfg_path2 ='./config_arc/arc_Insight_res100.yaml')
        callMe(cfg_path ='configs/config_arc/arc_Insight_res100.yaml', cfg_path2 ='./config_arc/arc_inceptionResNetV2.yaml')
        callMe(cfg_path ='configs/config_arc/arc_Xception.yaml', cfg_path2 ='./config_arc/arc_Insight_res100.yaml')
