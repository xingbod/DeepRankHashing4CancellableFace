function enroll_query_hashing_fusion(feat_path,feat_path2,filename_path)
...
fid=fopen('logs/log_orig_hashing_fusion.txt','a');
fwrite(fid,feat_path+"_"+feat_path2+" ");
fclose(fid)
dlmwrite('logs/log_orig_hashing_fusion.txt', perf, '-append');
end