...
% load('..\data\lfw_1024_facenet_embeddings_BLUFR.mat')

load('facedataset\lfw_256_facenet_embeddings.mat')
load('facedataset\lfw_label.mat')

fusion_embedding=lfw_256_facenet_embeddings;
