function enroll_query_search(feat_path,filename_path,measure,ds,remark)
...
% enroll_query_search("ResNet50_lfw_feat.csv","ResNet50_lfw_name.txt","Euclidean","LFW","orig_deep")
addpath('../');
