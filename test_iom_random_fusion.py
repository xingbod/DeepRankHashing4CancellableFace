...
def callMe(cfg_path = 'config_random/iom_res50_random.yaml',cfg_path2 = 'config_random/iom_res50_random_inceptionresnet.yaml'):
    ...
    def evl(isLUT, measure):
        ...
        with open('./logs/' + cfg['sub_name']+'_fuse_'+ cfg2['sub_name'] + "_Output_line_" + measure + '_layer_' + cfg[
...
for m in [32, 64, 128, 256, 512]:
    for q in [8]:
        ...
        mycfg['m'] = m
        mycfg['q'] = q
        callMe(cfg_path ='configs/config_random/iom_res50_random.yaml', cfg_path2 ='config_random/iom_res50_random_inceptionresnet.yaml')
        callMe(cfg_path ='configs/config_random/iom_res50_random.yaml', cfg_path2 ='config_random/iom_res50_random_xception.yaml')
        callMe(cfg_path ='configs/config_random/iom_res50_random_inceptionresnet.yaml', cfg_path2 ='config_random/iom_res50_random_xception.yaml')
