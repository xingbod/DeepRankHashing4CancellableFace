...
def load_online_pair_wise_dataset(dbdir,ext = 'jpg',dataset_ext = 'ms',samples_per_class = 3,classes_per_batch = 4,is_ccrop = False, buffer_size=10240):
    ...
    ds = path_ds.shuffle(buffer_size).interleave(lambda x: ListFiles(x, ext), cycle_length=10000,# every time, cycle_length classes are taken out to do the maping MS 85742
